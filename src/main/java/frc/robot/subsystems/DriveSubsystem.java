...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final CANEncoder m_leftEncoder = m_motor_L1.getEncoder(EncoderType.kQuadrature, 4096);

  // The right-side drive encoder
  private final CANEncoder m_rightEncoder = m_motor_R1.getEncoder(EncoderType.kQuadrature, 4096);
